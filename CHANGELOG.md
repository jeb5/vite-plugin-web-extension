...
- **devBuilder:** always use transformIndexHtml for HTML processing (#115)
...
- dev mode plugin HTML transforms are no longer applied by default. Use the devHtmlTransform plugin option to enable if needed.
...
- additionalInputs plugin option ([#88](https://github.com/samrum/vite-plugin-web-extension/issues/88)) ([cd9590e](https://github.com/samrum/vite-plugin-web-extension/commit/cd9590ee65cc4cf227c388bd56c69b3ca5206de0))
...
- **devBuilder:** match both single and double quotes in HTML ([#113](https://github.com/samrum/vite-plugin-web-extension/issues/113)) ([09b5998](https://github.com/samrum/vite-plugin-web-extension/commit/09b5998809ec671c39358f69cfc1aab1d221cf2c))
